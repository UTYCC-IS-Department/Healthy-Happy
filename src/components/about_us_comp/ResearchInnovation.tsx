...
// ============================================================================
// Translation Dictionary (Fallback & Route Sync)
// ============================================================================
const translations: Record<'en' | 'my', Record<string, string>> = {
  en: {
    title: 'Research & Innovation',
    topBannerText:
      'It has survived not only many decades, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised thanks',
    'rightSections.section1.title': 'Digital Transformation & Smart Systems',
    'rightSections.section1.description':
      'It has survived not only many decades, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised thanks',
    'rightSections.section2.title': 'Advanced Materials & Biotechnology',
    'rightSections.section2.description':
      'It has survived not only many decades, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised thanks',
  },
  my: {
    title: 'သုတေသနနှင့် ဆန်းသစ်တီထွင်မှု',
    topBannerText:
      'ဆယ်စုနှစ်ပေါင်းများစွာ ကြံ့ကြံ့ခံနိုင်ခဲ့ရုံသာမက လျှပ်စစ်စာစီစာရိုက် နည်းပညာသို့ ကူးပြောင်းရာတွင်လည်း အဓိကအနှစ်သာရ မပြောင်းလဲဘဲ ကျန်ရှိခဲ့ပါသည်။',
    'rightSections.section1.title': 'ဒီဂျစ်တယ် အသွင်ကူးပြောင်းမှုနှင့် စမတ်စနစ်များ',
    'rightSections.section1.description':
      'ဆယ်စုနှစ်ပေါင်းများစွာ ကြံ့ကြံ့ခံနိုင်ခဲ့ရုံသာမက လျှပ်စစ်စာစီစာရိုက် နည်းပညာသို့ ကူးပြောင်းရာတွင်လည်း အဓိကအနှစ်သာရ မပြောင်းလဲဘဲ ကျန်ရှိခဲ့ပါသည်။',
    'rightSections.section2.title': 'အဆင့်မြင့် ပစ္စည်းများနှင့် ဇီဝနည်းပညာ',
    'rightSections.section2.description':
      'ဆယ်စုနှစ်ပေါင်းများစွာ ကြံ့ကြံ့ခံနိုင်ခဲ့ရုံသာမက လျှပ်စစ်စာစီစာရိုက် နည်းပညာသို့ ကူးပြောင်းရာတွင်လည်း အဓိကအနှစ်သာရ မပြောင်းလဲဘဲ ကျန်ရှိခဲ့ပါသည်။',
  },
};
...
export const researchInnovationData: ResearchInnovationData = {
  topPillKey: 'topBannerText',
  leftCards: [{ id: 'card-1' }, { id: 'card-2' }, { id: 'card-3' }],
  rightSections: [
    {
      id: 'section-1',
      titleKey: 'rightSections.section1.title',
      descriptionKey: 'rightSections.section1.description',
    ...
    {
      id: 'section-2',
      titleKey: 'rightSections.section2.title',
      descriptionKey: 'rightSections.section2.description',
...
export const ResearchInnovation: React.FC = () => {
  ...
  const currentLang = useMemo<'en' | 'my'>(() => {
    if (pathname && pathname.startsWith('/my')) {
      return 'my';
    }
    return 'en';
  }, [pathname]);
        ...
        <div className="ri-content-grid">
          ...
          >
            ...
            <div className="ri-top-pill-banner">
              <AnimatePresence mode="wait">
                <motion.span
                  key={`banner-${currentLang}`}
                  variants={textFadeVariants}
                  initial="initial"
                  animate="animate"
                  exit="exit"
                >
                  {getText(researchInnovationData.topPillKey)}
                </motion.span>
              </AnimatePresence>
            </div>
                      ...
                      <div className="ri-row-top">
                        ...
                        <div className="ri-row-text-content">
                          <h3 className="ri-row-title">
                            <AnimatePresence mode="wait">
                              <motion.span
                                key={`sec-title-${section.id}-${currentLang}`}
                                variants={textFadeVariants}
                                initial="initial"
                                animate="animate"
                                exit="exit"
                              >
                                {getText(section.titleKey)}
                              </motion.span>
                            </AnimatePresence>
                          </h3>
                          <p className="ri-row-description">
                            <AnimatePresence mode="wait">
                              <motion.span
                                key={`sec-desc-${section.id}-${currentLang}`}
                                variants={textFadeVariants}
                                initial="initial"
                                animate="animate"
                                exit="exit"
                              >
                                {getText(section.descriptionKey)}
                              </motion.span>
                            </AnimatePresence>
                          </p>
                        </div>
